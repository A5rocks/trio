...
class CancelScope:
    ...
    def __attrs_post_init__(self) -> None:
        ...
        if self._relative_deadline != inf and self._deadline != inf:
            raise ValueError("Cannot specify both a deadline and a relative deadline")
...
class Nursery(metaclass=NoPublicConstructor):
    ...
    def _child_finished(self, task: Task, outcome: Outcome[object]) -> None:
    ...
    def spawn_system_task(
        ...
        * System tasks do not inherit context variables from their creator.
        ...
        return self.spawn_impl(
            async_fn, args, self.system_nursery, name, system_task=True, context=context
        )
